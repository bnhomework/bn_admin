  ...
  <div id="app">
      <el-header id="header">
        ...
        <div class="header-normal">
          ...
          <svg t="1492500959545" @click="toggleNavigation" class="wscn-icon hamburger" :class="{'is-active':!sideBarCollapse}" style="margin-left: 15px" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1691" xmlns:xlink="http://www.w3.org/1999/xlink" width="64" height="64">
